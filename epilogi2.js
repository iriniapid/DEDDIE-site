...
//add titles to data
    var titles= ['EF', 'HL', 'Q_FBS', 'EK_PMK', 'EK_PNK', 'XXD','ETMEAR', 'YKO_PEL', 'XXS', 'KEA','P_MAZUT', 'MK_MAZUT', 'P_DIESEL',
     'MK_DIESEL', 'P_CO2', 'MK_CO2', 'Q_SM','Q_APE', 'KL', 'RAV', 'D', 'O', 'ED','MPKP','MMK'];
    var rawdata = JSON.parse(localStorage.getItem("InputData")); 
    var mydata = rawdata["data"];
    for (var i = 0; i < Object.values(mydata).length; i++) {
      Object.values(mydata)[i].unshift(titles);
    }

    var HL_S = ["All","Σ08","Σ17","Σ11","Σ32","Σ07","Σ23","Σ15","Σ28","Σ19","Σ14","Σ12","Σ09","Σ01","Σ22","Σ20","Σ21","Σ06","Σ03","Σ25","Σ26"];
